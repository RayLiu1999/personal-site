<template>
  <div>
    ...
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="text-center">
          ...
          <h1
            class="text-4xl md:text-7xl font-bold text-coffee-800 dark:text-white mb-6 tracking-tight"
          >
            {{ $t("home.hero.greeting") }}
            <span class="text-coffee-600 dark:text-blue-400">{{
              displayedName
            }}</span
          ...
          <p
            class="text-xl md:text-2xl text-coffee-700 dark:text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 animate-fade-in-up"
            style="animation-delay: 0.5s; animation-fill-mode: forwards"
          >
            {{ $t("home.hero.intro_part1")
            }}<span class="font-semibold text-coffee-800 dark:text-blue-300">{{
              $t("home.hero.role")
            }}</span
            >{{ $t("home.hero.intro_part2") }}
            <br class="hidden md:block" />
            {{ $t("home.hero.intro_part3")
            }}<span class="highlight-text">{{
              $t("home.hero.intro_highlight1")
            }}</span
            >{{ $t("home.hero.and1")
            }}<span class="highlight-text">{{
              $t("home.hero.intro_highlight2")
            }}</span
            >{{ $t("home.hero.and2")
            }}<span class="highlight-text">{{
              $t("home.hero.intro_highlight3")
            }}</span
            >{{ $t("home.hero.intro_part4") }}
          </p>

          <div
            class="flex flex-col sm:flex-row gap-6 justify-center opacity-0 animate-fade-in-up"
          ...
          >
            ...
            >
              <span
                class="absolute inset-0 w-full h-full bg-white/20 opacity-0 group-hover:opacity-100 group-hover:translate-x-full transition-all duration-500 ease-out -translate-x-full skew-x-12"
              ></span>
      ...
      >
        <svg
          class="w-8 h-8 text-coffee-400 dark:text-gray-500"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <section
      id="content"
      class="py-24 bg-white dark:bg-gray-800 transition-colors"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 scroll-reveal">
          <h2
            class="text-4xl font-bold text-coffee-800 dark:text-white mb-4 relative inline-block"
          >
            {{ $t("home.blog.title") }}
            <span
              class="absolute bottom-0 left-0 w-full h-2 bg-coffee-200/50 dark:bg-blue-500/30 -rotate-1 rounded-full"
            ></span>
          </h2>
          <p class="text-xl text-coffee-600 dark:text-gray-400 mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          >
            ...
            <div class="p-8">
              <div
                class="flex items-center text-coffee-500 dark:text-gray-400 text-sm mb-4"
              >
                <span
                  class="px-3 py-1 bg-white/50 dark:bg-gray-600 rounded-full backdrop-blur-sm"
                >
                  {{ post.date }}
                </span>
              </div>
              ...
              <p
                class="text-coffee-600 dark:text-gray-300 text-sm mb-6 line-clamp-3 leading-relaxed"
              >
                {{ post.excerpt }}
              </p>
              <div
        ...
        <div class="text-center mt-16 scroll-reveal">
          <a
            href="https://blog.liu-yucheng.com"
            target="_blank"
    ...
    <!-- Recent Projects -->
    <section
      class="py-24 bg-coffee-50 dark:bg-gray-900 transition-colors relative overflow-hidden"
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16 scroll-reveal">
          <h2 class="text-4xl font-bold text-coffee-800 dark:text-white mb-4">
            {{ $t("home.projects.title") }}
          </h2>
          <p class="text-xl text-coffee-600 dark:text-gray-400">
        ...
        <div class="flex flex-wrap justify-center gap-8">
          ...
          >
            ...
            >
              ...
              />
              <div
                class="absolute inset-0 bg-coffee-900/0 group-hover:bg-coffee-900/20 transition-colors duration-300"
              ></div>
            </NuxtLink>
            <div class="p-8 flex flex-col flex-grow relative">
              ...
              <p
                class="text-coffee-600 dark:text-gray-300 mb-6 flex-grow leading-relaxed"
              >
                {{ project.description }}
              </p>
...
const handleAvatarMove = (e) => {
  ...
  const { left, top, width, height } =
    avatarContainer.value.getBoundingClientRect();
...
const featuredProjects = computed(() => [
  {
    ...
    githubs: [
      ...
      "https://github.com/RayLiu1999/cyptocurrency-exchange-backend",
    ],
  },
  {
    id: 1,
    ...
    githubs: [
      ...
      "https://github.com/RayLiu1999/chat_app_backend",
    ],
  },
]);
</script>
